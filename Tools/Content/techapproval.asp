...
ls_sql = "SELECT Tech_Area.Tech_Area, Tech.Tech_Name, Tech.Tech_Desc, Tech.Approved," _
	& " Tech.Tech_ID, Tech.Tech_Area_ID, Employee.FirstName, Employee.LastName, Tech.Employee_ID" _
	& " FROM Tech INNER JOIN Tech_Area ON" _
	& " Tech.Tech_Area_ID = Tech_Area.Tech_Area_ID INNER JOIN Employee ON" _
	& " Tech.Employee_ID = Employee.EmployeeID" _
...
if not rs.eof then
	...
	ls_EEFirst=rs("FirstName")
	ls_EELast=rs("LastName")
	ls_EEID=rs("Employee_ID")
	Response.Write("<tr><td colspan=2>&nbsp</td></tr>")
	Response.Write("<tr><td width='18%' align=right><font size=1 face='ms sans serif, arial, geneva'>Submitted By: </font></td>")
	'Response.Write("<td><font size=1 face='ms sans serif, arial, geneva'><a href='mailto:" & mid(ls_EEFirst,1,1) & ls_EELast & "@sark.com'>" & ls_EEFirst & "&nbsp;" & ls_EELast & "</a></font></td></tr>")
	Response.Write("<td><font size=1 face='ms sans serif, arial, geneva'><a href='../../directory/content/details.asp?EmpID=" & ls_EEID & "'>" & ls_EEFirst & "&nbsp;" & ls_EELast & "</a></font></td></tr>")
