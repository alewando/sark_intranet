...
<form NAME="frmReturn" ACTION="techexperts.asp?empid=<%=Request.QueryString("EmpID")%>" METHOD="POST">
	...
	If not rs.eof Then
		...
		rs.close
		response.Write("<tr><td><font size=1 face='ms sans serif, arial, geneva'>")
	...
	Else
		...
		strSQL = "INSERT INTO tech (Tech_Name, Tech_Desc, Tech_Standard, Tech_Area_ID) " & _
		         "VALUES ('" & strNewTechName & "', '" & strNewTechDesc & "', 1, " & intTechArea & ")"
		DBQuery(strSQL)
		...
		Response.Write("<tr><td><font size=1 face='ms sans serif, arial, geneva'><b>")
		Response.Write("Your newly suggested technology has been noted. ")
		Response.Write("If approved, it will soon be listed under technical expertise.</b></FONT></td></tr>")
	End If
	%>
