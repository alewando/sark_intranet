...
<form NAME="frmNewTech" ACTION="addnewtech_process.asp">
	...
	<tr><td><font size=1 face="ms sans serif, arial, geneva">
		<b>Name:</b><br>
		<center>
		<INPUT TYPE=TEXT NAME="txtNewTechName" ID="txtNewTechName" VALUE="" SIZE="50" MAXLENGTH="50">
		</center>
	    <P>&nbsp;</P>
	</font></td></tr>
	...
	<tr><td><font size=1 face="ms sans serif, arial, geneva">
		...
		<!--<INPUT TYPE=TEXT NAME="txtNewTechDesc" ID="txtNewTechDesc" VALUE="" SIZE="50" MAXLENGTH="200">-->
			<textarea name="txtNewTechDesc" ID="txtNewTechDesc" rows='5' cols='50' wrap='on'></textarea>
		</center>
	</font></td></tr>
	</table>
