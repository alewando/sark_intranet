...
If rs.eof Then
	...
	sql = "SELECT sg.GroupName, s.isOtherSkill, SkillValue = s.SkillName, s.SkillName, s.SkillID, sr.SkillRanking " &_
...
Else
	...
	sql = "SELECT sg.GroupName, s.isOtherSkill, si.SkillValue, s.SkillName, s.SkillID, sr.SkillRanking " &_
