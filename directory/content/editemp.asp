...
<tr>
	<td align=right><font size=1 face="ms sans serif, arial, geneva">Fax:</font></td>
	<td><INPUT TYPE="Text" NAME="Fax" VALUE="<%=ls_fax%>" size=40 maxlength=255></td>
</tr>
<tr>
	<td align=right><font size=1 face="ms sans serif, arial, geneva">Instant Messenger ID:</font></td>
	<td><INPUT TYPE="Text" NAME="Msngrid" VALUE="<%=ls_msngrid%>" size=10 maxlength=255></td>
</tr>
<tr>
